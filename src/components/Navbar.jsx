      ...
      return(
        ...
        <div className="p-4 flex justify-around border-b-2 border-solid  border-violet-50 z-100">
         ...
         <div className="flex w-7/12 justify-evenly">
           ...
           <input autocomplete="off" id="search-input" type='text' placeholder="start your search here" className="rounded-full text-xs text-semibold w-12/12 h-7 mr-1"
           onChange={(e)=>{
